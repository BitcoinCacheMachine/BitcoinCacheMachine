...
bcm cluster create --driver=ssh --cluster-name="LocalCluster" --ssh-username="$(whoami)" --ssh-hostname="$(hostname)"
#bcm cluster create --driver=multipass --cluster-name="multipass-$(hostname)"
