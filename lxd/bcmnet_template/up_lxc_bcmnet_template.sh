...
lxc config set $BCM_LXC_BCMNETTEMPLATE_CONTAINER_NAME environment.HTTP_PROXY http://gateway.bcmnet:3128/
lxc config set $BCM_LXC_BCMNETTEMPLATE_CONTAINER_NAME environment.HTTPS_PROXY http://gateway.bcmnet:3128/
...
lxc exec $BCM_LXC_BCMNETTEMPLATE_CONTAINER_TEMPLATE_NAME -- mkdir -p /etc/pki/tls/certs
lxc file push ~/.bcm/runtime/$(lxc remote get-default)/bcm-gateway/squid/squid.cert.DER $BCM_LXC_BCMNETTEMPLATE_CONTAINER_TEMPLATE_NAME/etc/pki/tls/certs/ca-bundle.crt
