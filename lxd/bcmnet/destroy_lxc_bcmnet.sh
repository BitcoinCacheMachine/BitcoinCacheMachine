...
bash -c "$BCM_LOCAL_GIT_REPO_DIR/lxd/shared/delete_lxc_container.sh $BCM_BCMNETTEMPLATE_CONTAINER_DELETE $BCM_LXC_BCMNETTEMPLATE_CONTAINER_TEMPLATE_NAME"

# delete networks
bash -c "$BCM_LOCAL_GIT_REPO_DIR/lxd/shared/delete_lxc_network.sh $BCM_BCMNETTEMPLATE_NETWORK_LXDBR0CACHESTACK_DELETE lxdbrCachestack"

# delete 'BCM_LXC_GATEWAY_STORAGE_DOCKERVOL_NAME'
bash -c "$BCM_LOCAL_GIT_REPO_DIR/lxd/shared/delete_lxc_storage.sh $BCM_BCMNETTEMPLATE_STORAGE_DOCKERVOL_DELETE bcm-bcmnet-template-dockervol"
