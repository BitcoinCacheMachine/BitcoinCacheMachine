...
bash -c "$BCM_LOCAL_GIT_REPO_DIR/lxd/shared/create_attach_lxc_storage_to_container.sh $BCM_GATEWAY_STORAGE_DOCKERVOL_CREATE $BCM_LXC_GATEWAY_CONTAINER_NAME $BCM_LXC_GATEWAY_STORAGE_DOCKERVOL_NAME"

lxc start $BCM_LXC_GATEWAY_CONTAINER_NAME

bash -c "$BCM_LOCAL_GIT_REPO_DIR/lxd/shared/wait_for_dockerd.sh $BCM_LXC_GATEWAY_CONTAINER_NAME"
