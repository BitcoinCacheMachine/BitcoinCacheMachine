...
bash -c "$BCM_LOCAL_GIT_REPO/lxd/shared/generate_certificate.sh $BCM_LXC_GATEWAY_CONTAINER_NAME private_registry bcmnet"
...
lxc exec bcm-gateway -- env REGISTRY_HTTP_SECRET="CHANGEME" docker stack deploy -c /apps/private_registry/private_registry.yml privateregistry
