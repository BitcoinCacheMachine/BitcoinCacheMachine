...
* Provide a self-contained, event-driven, software-defined network that deploys a composable and fully operational Bitcoin and Lightning-related IT infrastructure.
