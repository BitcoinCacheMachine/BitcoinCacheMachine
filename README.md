...
Each of the commands listed above has a negative command, e.g., `bcm stack undeploy`, `bcm deprovision`, `bcm cluster destroy`, and `bcm reset`, respectively. Consider running `bcm info` to determine your active environment variables.
