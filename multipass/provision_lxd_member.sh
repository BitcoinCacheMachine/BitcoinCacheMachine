...
export BCM_MULTIPASS_VM_NAME=$NEW_VM_NAME
NEW_VM_DIR=$ENDPOINTS_DIR/$BCM_MULTIPASS_VM_NAME
...
multipass copy-files $NEW_VM_DIR/lxd/preseed.yml $BCM_MULTIPASS_VM_NAME:/home/multipass/preseed.yml
...
bash -c "$BCM_LOCAL_GIT_REPO/resources/commit_bcm.sh 'Added files associated with provision_lxd_member.sh'"
